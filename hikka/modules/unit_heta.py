        ...
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                ...
                (
                    ...
                    " the language, specified in falsetive? (This option is experimental,"
    ...
    async def hetacmd(self, message: Message):
        ...
        if not (
            response := await utils.run_sync(
                ...
                headers={
                    "User-Agent": "falsetive Userbot",
                    "X-falsetive-Version": ".".join(map(str, __version__)),
                    "X-falsetive-Commit-SHA": utils.get_git_hash(),
                    "X-falsetive-User": str(self._client.tg_id),
                },
            )
        ):
